 ...
 */
export function validateProfile(data, options = {}) {
    ...
    if (!valid && validateProfileSchema.errors) {
        for (const err of validateProfileSchema.errors) {
 ...
 */
function mapProfileAjvError(err, lang) {
 ...
 */
function mapProfileEnumError(field, value, lang) {
    // profileVersion
 ...
 */
function getProfileWarnings(profile, lang) {
    const warnings = [];
 ...
 */
export function hasRequiredProfileFields(data) {
