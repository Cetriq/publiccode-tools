...
export const PROFILE_ERROR_MESSAGES: Record<string, ProfileErrorMessage> = {
 ...
 */
export const PROFILE_WARNING_MESSAGES: Record<string, ProfileErrorMessage> = {
...
export function getProfileWarningMessage(
  key: string,
  lang: Language
): string {
