  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 pt-32 pb-16">
      <div className="mx-auto max-w-2xl px-4">
        ...
        <Link
          href="/kom-igang"
          className="mb-6 inline-flex items-center gap-2 text-slate-400 hover:text-white transition"
        >
        ...
        <div className="rounded-2xl bg-white/10 p-8 backdrop-blur">
          ...
          {step === 'login' && (
            <div className="text-center">
              <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-green-500 to-teal-500">
              ...
              <p className="mt-4 text-lg text-slate-300">
                Sätt upp GitHub Action för att automatiskt registrera alla repos med publiccode.yml.
              </p>
              <button
          ...
          {step === 'select-org' && (
            <div>
              ...
              <p className="mt-2 text-slate-300">
                Välj vilken organisation du vill sätta upp automatisering för.
              </p>
          ...
          {step === 'confirm' && selectedOrg && (
            <div>
              ...
              <p className="mt-2 text-slate-300">
                Du är på väg att sätta upp automatisering för:
              </p>
              ...
              <div className="mt-6 rounded-lg bg-blue-500/20 p-4 text-blue-200">
                ...
                <ul className="mt-2 list-inside list-disc space-y-1 text-sm">
                  ...
                  <li>Dina projekt registreras automatiskt vid varje push</li>
                </ul>
              </div>
              ...
              <div className="mt-8 flex gap-4">
                ...
                >
                  {loading ? 'Registrerar...' : 'Skapa API-nyckel'}
                </button>
              </div>
            </div>
          )}
          ...
          {step === 'success' && apiKey && (
            <div>
              <div className="text-center">
                ...
                <p className="mt-2 text-slate-300">
                  Kopiera nyckeln och följ instruktionerna nedan.
                </p>
              </div>
              ...
              <div className="mt-8">
                <h3 className="font-semibold text-white">Konfigurera GitHub Action</h3>
                <ol className="mt-4 list-inside list-decimal space-y-4 text-slate-300">
                  <li>
                    <strong>Lägg till secret i GitHub:</strong>
                    <div className="mt-2 ml-5 text-sm">
                      Gå till ditt repos <code className="rounded bg-slate-700 px-2 py-0.5">Settings → Secrets and variables → Actions</code>
                      <br />
                  ...
                  <li>
                    <strong>Lägg till Action i ditt repo:</strong>
                    <div className="mt-2 ml-5">
                      <p className="text-sm mb-2">Skapa filen <code className="rounded bg-slate-700 px-2 py-0.5">.github/workflows/publiccode.yml</code>:</p>
                      <pre className="rounded-lg bg-slate-800 p-4 text-sm text-slate-300 overflow-x-auto">
{`name: Publiccode Registry
on:
  push:
    paths:
      - 'publiccode.yml'
...
jobs:
  register:
    ...
    steps:
      ...
      - uses: godwana/publiccode-action@v1
        with:
          api-key: \${{ secrets.PUBLICCODE_REGISTRY_API_KEY }}`}
                      </pre>
                    </div>
                  </li>
                  <li>
                    <strong>Klar!</strong> Nu registreras ditt projekt automatiskt när du pushar ändringar till publiccode.yml.
                  </li>
                </ol>
              </div>
              ...
              <div className="mt-8 flex gap-4">
                <Link
                  href="/editor"
                  className="rounded-xl bg-white/10 px-6 py-3 font-medium text-white text-center transition hover:bg-white/20"
                >
